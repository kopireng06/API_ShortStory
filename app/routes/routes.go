...
func (controller RouteControllerList) RouteRegister(c *echo.Echo) {
	...
	authors.PUT("", controller.AuthorController.EditAuthor, token.MiddlewareAuthor)
	authors.GET("", controller.AuthorController.GetAllAuthors)
	authors.GET("/:id", controller.AuthorController.GetAuthorById)
	authors.GET("/search/:name", controller.AuthorController.GetAuthorsByName)
	...
	stories.GET("/author/:id", controller.ShortStoryController.GetShortStoriesByIdAuthor)
	stories.GET("/category/:id", controller.ShortStoryController.GetShortStoriesByIdCategory)
	stories.GET("/search/:title", controller.ShortStoryController.GetShortStoriesByTitle)
